...
| Property       | Value                                                                                                                         |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| AWS Account ID | 433146033010                                                                                                             |
| Account Email  | dev@margagl.info                                                                                                      |
| Login URL      | <https://signin.aws.amazon.com/switchrole?account=433146033010&roleName=OrganizationAccountAccessRole&displayName=minfo-dev-admin> |
| Namespace      | minfo                                                                                                                  |
| Stage          | dev                                                                                                                      |
...
Here is the list of some of the tools we use to provision `dev.margagl.info` infrastructure in order to facilitate cloud fabrication and administration:
...
```bash
/usr/local/bin/dev.margagl.info
```

**NOTE (a):** You can just run `dev.margagl.info`, if your `PATH` contains `/usr/local/bin`
